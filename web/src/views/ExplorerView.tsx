...
const ExplorerView = () => {
  ...
  const [query, setQuery] = useState(searchParams.get("query") || QUERY);
  const [queryResult, setQueryResult] = useState(
    undefined as QueryResultSetWithSources | undefined
  );
                ...
                <div className={styles.queryFieldContainer}>
                  <div className={styles.queryFieldContainerInner}>
                    <div className={styles.resultsSummary}>
                      {queryResult ? (
                        <span>
                          {queryResult.items.length} results founds in{" "}
