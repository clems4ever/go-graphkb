...
WHERE (a0.type = 'variable' AND a1.type = 'name' AND r0.type = 'has' AND (r0.from_id = a1.id AND r0.to_id = a0.id))`,
		...
		QueryCase{
			...
			SQL: `
SELECT a1.* FROM assets a0, assets a1, relations r0
WHERE (a0.type = 'variable' AND a1.type = 'name' AND ((r0.from_id = a0.id AND r0.to_id = a1.id) OR (r0.from_id = a1.id AND r0.to_id = a0.id)))`,
		},
		QueryCase{
...
LIMIT 10`,
		...
		QueryCase{
			...
			SQL: `
SELECT a1.* FROM assets a0, assets a1, relations r0, relations r1
